...
<div class="form-group">
                 ...
                 <option value="El tigre">Seccion:D01 Telecomunicaciones - Regimen: diurno - Pensum: 2010</option>
                         <option value="El tigre">Seccion:D01 Telecomunicaciones - Regimen: diurno - Pensum: 2010</option>
...
<p class="" align="center">
  ...
  <draggable   id="estado1" ondrop="arrastrar(event)" ondragover="alojar(event)">

<span  class="" value"true" draggable="true" ondragstart="soltar(event)" id="estado1">

<button class="btn btn-success btn-xs">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">D01-Sistemas </span>
</button>
...
<p   align="center">  <strong><i class="fa fa-address-book" aria-hidden="true"></i> Asignaturas </strong>  </p>
<p  align="center">


<draggable   id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
<span  class="btn btn-success btn-xs" value"true" draggable="true" ondragstart="drag(event)" id="drag1">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">Matematica </span>
      </draggable>
...
<span  class="btn btn-success btn-xs" value"true" draggable="true" ondragstart="drag(event)" id="drag1">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">Algebra lineal </span>
      </draggable>

      <draggable   id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
<span  class="btn btn-success btn-xs" value"true" draggable="true" ondragstart="drag(event)" id="drag1">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">Geometria </span>
      </draggable>
   <draggable   id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
<span  class="btn btn-success btn-xs" value"true" draggable="true" ondragstart="drag(event)" id="drag1">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">Fisica Teoria</span>
      </draggable>
   <draggable   id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
<span  class="btn btn-success btn-xs" value"true" draggable="true" ondragstart="drag(event)" id="drag1">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">Fisica Laboratorio </span>
      </draggable>
   <draggable   id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
<span  class="btn btn-success btn-xs" value"true" draggable="true" ondragstart="drag(event)" id="drag1">
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="" name="profesor">Geometria Analitica </span>
      </draggable>
...
Nuevo horario</strong>



                           
<select  id="ciudad" name="ciudad" class="form-control input-sm" >
<option value="" selected="">Infraestructura</option>
<option value="El tigre">Unefa, san tome</option>

</select>

<select  id="ciudad" name="ciudad" class="form-control input-sm" >
<option value="" selected="">Edificio</option>
<option value="El tigre">1-A</option>
</select>
...
<option value="El tigre">A03</option>
</select>
...
<ul class="list-inline">
  <li><i class="fa fa-bookmark" aria-hidden="true"></i> <strong>    Seccion</strong>  

<div title="Arrastre y suelta una seccion"
ondrop="soltar(event)" ondragover="alojar(event)"  
 style=" width:104px;height:35px ;   border: 2px dashed green; " class="">
...
<center>
       <button class="btn btn-default btn-xs" title="Seccion" >   

         <i class="fa fa-bookmark" aria-hidden="true"></i>
D01-Ingenieria de Sistemas
</button>  
   ...
   <button class="btn btn-default btn-xs" title="Seccion" >   
         ...
         <i class="fa fa-bookmark" aria-hidden="true"></i>
D02-Ingenieria de Telecomunicaciones
</button>  
   <button class="btn btn-default btn-xs" title="Seccion" >   

         <i class="fa fa-bookmark" aria-hidden="true"></i>
D02-Ingenieria de Petrolero
</button>  
