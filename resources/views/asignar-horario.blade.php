...
<i class="fa fa-clock-o" aria-hidden="true"></i>
  <input type="hidden" id="profesor" value="{{$profesor }} " name="profesor">{{$profesor }}  </span>
...
<span  class="text-info"   style="padding-right: 25px;"> 
<i class="fa fa-building" title="Infraestructura" aria-hidden="true"></i> Infraestructura Unefa 
</span>
<span  class="text-info" style="padding-right: 25px;"> 
 <i title="Aula" class="fa fa-flag" aria-hidden="true"></i> Aula 15 </span>
<span   class="text-info" style="padding-right: 25px;"> 
 <i class="fa fa-id-badge" aria-hidden="true"></i> Seccion D02 </span>

<span  class="text-info" style="padding-right: 25px;"> 
 <i class="fa fa-address-book" aria-hidden="true"></i> Asignatura Fisica </span>
...
<span class="text-success"  title="Estatus" style=""> 
<i class="fa fa-check-circle" aria-hidden="true"></i> Activo</span>
